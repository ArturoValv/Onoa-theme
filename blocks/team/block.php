            ...
            <div class="cols">
                ...
                <div class="col">
                    ...
                    <div class="team">
                        ...
                        <?php foreach ($miembros_del_equipo as $member): ?>

                            <div class="member">
                                <<?= $enlazar_miembros_con_su_biografia ? "a href='" . get_the_permalink($member) . "' " : "picture"; ?> class="photo">
                                    <?= get_the_post_thumbnail($member, 'portrait') ?>
                                </<?= $enlazar_miembros_con_su_biografia ? "a" : "picture"; ?>>

                                <div class="info">
                                    <p class="heading">
                                        <?= $enlazar_miembros_con_su_biografia ? " <a href=" . get_the_permalink($member) . "'>" : "" ?>
                                        <?= get_the_title($member) ?>
                                        <?= $enlazar_miembros_con_su_biografia ? " </a>" : "" ?>
                                    </p>
                                    <p class="position"><?= get_field("puesto", $member) ?></p>
                                </div>

                                <?php
                                $redes = get_field("redes_sociales", $member);
                                if (!empty($redes)) :
                                ?>
                                    <ul class="social">
